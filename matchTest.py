...
'''
    GITHUB LINK TIL HVOR DET KOMMER FRA
    https://github.com/brkyzdmr/TemplateMatcher/blob/main/README.md#prerequisites
'''

MIN_MATCH_COUNT = 2

parser = argparse.ArgumentParser(description='Template matcher')
parser.add_argument('ImageFiles/crown3.png', type=str, action='store',
                    help='The image to be used as template')
parser.add_argument('ImageFiles/CroppedBoards/1.jpg', type=str, action='store',

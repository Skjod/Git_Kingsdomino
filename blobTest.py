...
# Load image
imageMatch = cv2.imread("ImageFiles/CroppedBoards/2.jpg")
img = cv2.imread("ImageFiles/CroppedBoards/2.jpg", cv2.IMREAD_GRAYSCALE)
temp = cv2.imread("ImageFiles/crown3.png")
temp90 = cv2.imread("ImageFiles/crown90.png")
temp180 = cv2.imread("ImageFiles/crown180.png")
temp270 = cv2.imread("ImageFiles/crown270.png")
